...
def main():
    ...
    for i in tqdm(range(5), desc="Warm Up..."):
        ...
        # torch.compiler.cudagraph_mark_step_begin()   # ← 新增这行
    ...
    for _ in tqdm(range(10), desc="Test Inference"):
        ...
        # generated, _ = generate(model, input_ids, past_key_values, max_new_tokens, activate_timing=False)
        # past_key_values.reset()
